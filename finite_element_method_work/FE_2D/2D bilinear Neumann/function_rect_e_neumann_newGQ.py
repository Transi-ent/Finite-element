...
def gauss_quadrature_stiff(N1,N2,n,alpha,beta):
    ...
    r=(4/(h1**2))*((25/81)*phix(-0.7745967,-0.7745967,alpha)*phix(-0.7745967,-0.7745967,beta)*J_suffix(-0.7745967,-0.7745967,X,Y)+
                   (40/81)*phix(-0.7745967,0,alpha)*phix(-0.7745967,0,beta)*J_suffix(-0.7745967,0,X,Y)+
                   (25/81)*phix(-0.7745967,0.7745967,alpha)*phix(-0.7745967,0.7745967,beta)*J_suffix(-0.7745967,0.7745967,X,Y)+
                   (40/81)*phix(0,-0.7745967,alpha)*phix(0,-0.7745967,beta)*J_suffix(0,-0.7745967,X,Y)+
                   (64/81)*phix(0,0,alpha)*phix(0,0,beta)*J_suffix(0,0,X,Y)+
                   (40/81)*phix(0,0.7745967,alpha)*phix(0,0.7745967,beta)*J_suffix(0,0.7745967,X,Y)+
                   (25/81)*phix(0.7745967,-0.7745967,alpha)*phix(0.7745967,-0.7745967,beta)*J_suffix(0.7745967,-0.7745967,X,Y)+
                   (40/81)*phix(0.7745967,0,alpha)*phix(0.7745967,0,beta)*J_suffix(0.7745967,0,X,Y)+
                   (25/81)*phix(0.7745967,0.7745967,alpha)*phix(0.7745967,0.7745967,beta)*J_suffix(0.7745967,0.7745967,X,Y)  )+\
      (4/(h2**2))*((25/81)*phiy(-0.7745967,-0.7745967,alpha)*phiy(-0.7745967,-0.7745967,beta)*J_suffix(-0.7745967,-0.7745967,X,Y)+
                   (40/81)*phiy(-0.7745967,0,alpha)*phiy(-0.7745967,0,beta)*J_suffix(-0.7745967,0,X,Y)+
                   (25/81)*phiy(-0.7745967,0.7745967,alpha)*phiy(-0.7745967,0.7745967,beta)*J_suffix(-0.7745967,0.7745967,X,Y)+
                   (40/81)*phiy(0,-0.7745967,alpha)*phiy(0,-0.7745967,beta)*J_suffix(0,-0.7745967,X,Y)+
                   (64/81)*phiy(0,0,alpha)*phiy(0,0,beta)*J_suffix(0,0,X,Y)+
                   (40/81)*phiy(0,0.7745967,alpha)*phiy(0,0.7745967,beta)*J_suffix(0,0.7745967,X,Y)+
                   (25/81)*phiy(0.7745967,-0.7745967,alpha)*phiy(0.7745967,-0.7745967,beta)*J_suffix(0.7745967,-0.7745967,X,Y)+
                   (40/81)*phiy(0.7745967,0,alpha)*phiy(0.7745967,0,beta)*J_suffix(0.7745967,0,X,Y)+
                   (25/81)*phiy(0.7745967,0.7745967,alpha)*phiy(0.7745967,0.7745967,beta)*J_suffix(0.7745967,0.7745967,X,Y)  )
...
def J_suffix(x,y,X,Y):
    """ Return a result, abs(J(kesi,iter)) """
    x_k=0.25*(-X[0]*(1-y)+(X[1]*(1-y))+(X[2]*(1+y))-(X[3]*(1+y)))
    y_i=0.25*((-Y[0]*(1-x))-Y[1]*(1+x)+Y[2]*(1+x)+Y[3]*(1-x))
    y_k=0.25*(-Y[0]*(1-y)+Y[1]*(1-y)+Y[2]*(1+y)-Y[3]*(1+y))
    x_i=0.25*(-X[0]*(1-x)-X[1]*(1+x)+X[2]*(1+x)+X[3]*(1-x))
    return x_k*y_i-x_i*y_k
def phix(x,y,beta):
    if beta==0:
        return -0.25*(1-y)
    elif beta==1:
...
def gauss_quadrature_load(N1,N2,n_e,beta):
    ...
    for i in range(Nlb):
        X[i],Y[i]=P_function(N1,N2,index_lis[i])
    r  =  (25/81)*f(-0.7745967,-0.7745967,X,Y)*pusi(-0.7745967,-0.7745967,beta)*J_suffix(-0.7745967,-0.7745967,X,Y)+\
          (40/81)*f(-0.7745967,0,X,Y)*pusi(-0.7745967,0,beta)*J_suffix(-0.7745967,0,X,Y)+\
          (25/81)*f(-0.7745967,0.7745967,X,Y)*pusi(-0.7745967,0.7745967,beta)*J_suffix(-0.7745967,0.7745967,X,Y)+\
          (40/81)*f(0,-0.7745967,X,Y)*pusi(0,-0.7745967,beta)*J_suffix(0,-0.7745967,X,Y)+\
          (64/81)*f(0,0,X,Y)*pusi(0,0,beta)*J_suffix(0,0,X,Y)+\
          (40/81)*f(0,0.7745967,X,Y)*pusi(0,0.7745967,beta)*J_suffix(0,-0.7745967,X,Y)+\
          (25/81)*f(0.7745967,-0.7745967,X,Y)*pusi(0.7745967,-0.7745967,beta)*J_suffix(0.7745967,-0.7745967,X,Y)+\
          (40/81)*f(0.7745967,0,X,Y)*pusi(0.7745967,0,beta)*J_suffix(0.7745967,0,X,Y)+\
          (25/81)*f(0.7745967,0.7745967,X,Y)*pusi(0.7745967,0.7745967,beta)*J_suffix(0.7745967,0.7745967,X,Y)
...
def f(x,y,X,Y):
    x_lo=X[0]*pusi(x,y,0)+X[1]*pusi(x,y,1)+X[2]*pusi(x,y,2)+X[3]*pusi(x,y,3)
    y_lo=Y[0]*pusi(x,y,0)+Y[1]*pusi(x,y,1)+Y[2]*pusi(x,y,2)+Y[3]*pusi(x,y,3)
